"""
Ensemble scoring system combining RAG analysis with quantitative financial metrics.
"""
...
class ScoringConfig:
    ...
    sentiment_aspects: List[Dict[str, Any]] = field(default_factory=lambda: [
        {
            "name": "Revenue & Growth",
            "question": "What are the revenue trends, growth rates, and sales performance? Provide specific numbers.",
            "weight": 0.25
        },
        {
            "name": "Profitability",
            "question": "What are the profit margins, net income, and profitability trends? Include specific percentages.",
            "weight": 0.20
        },
        {
            "name": "Risk Factors",
            "question": "What are the key risk factors, challenges, and threats mentioned in the report?",
            "weight": 0.15
        },
        {
...
class ScoringResult:
    ...
    def __str__(self) -> str:
        ...
        return f"""
╔══════════════════════════════════════════════════════════════╗
║           STOCK PREDICTION SCORE - {self.ticker}
╚══════════════════════════════════════════════════════════════╝
...
COMPONENT BREAKDOWN:
  • Sentiment Analysis:     {self.sentiment_score:.1f}/100
  • Year-over-Year Trend:   {self.yoy_trend_score:.1f}/100
  • Risk-Adjusted Score:    {self.risk_adjusted_score:.1f}/100
  • Quantitative Metrics:   {self.quantitative_score:.1f}/100
  • LLM Judge Assessment:   {self.llm_judge_score:.1f}/100
...
class EnsembleScorer:
    ...
    def score_company(
        ...
        """
        print(f"\n{'='*60}")
        print(f"GENERATING STOCK PREDICTION SCORE FOR {ticker}")
        print(f"{'='*60}\n")
        ...
        print("📊 Step 1/5: Fetching financial data from yfinance...")
        ...
        print(f"   ✓ Data completeness: {financial_data.get('data_completeness', 0):.1f}%")
        
        # 2. Sentiment Analysis
        print("\n💭 Step 2/5: Analyzing sentiment from annual report...")
        ...
        print("\n📈 Step 3/5: Analyzing year-over-year trends...")
        yoy_result = self._analyze_yoy_trends(finrag, financial_data)
        yoy_score = yoy_result["score"]
        print(f"   ✓ YoY trend score: {yoy_score:.1f}/100")
        
        # 4. Risk-Adjusted Scoring
        print("\n⚖️  Step 4/5: Calculating risk-adjusted score...")
        ...
        print("\n🔢 Step 5/5: Scoring quantitative metrics...")
        ...
        print("\n🤖 Generating LLM judge assessment...")
    ...
    def _analyze_yoy_trends(self, finrag, financial_data: Dict) -> Dict[str, Any]:
        ...
        try:
            ...
            print(f"   ⚠ Error in YoY analysis: {str(e)}")
    ...
    def _calculate_risk_adjusted_score(
        ...
        try:
            ...
            print(f"   ⚠ Error in risk adjustment: {str(e)}")
